...
def target_directory(proj_root_dir, model_path_datetime, n_hq_epochs=False, model_type='roberta'):
    target_log_dir = os.path.join(proj_root_dir, 'logs','experiments','stage_1_experiment', model_path_datetime)
    best_model_path = ''
    if n_hq_epochs:
        best_model_path = os.path.join(target_log_dir, 'ce_checkpoint', f'{model_type}_best_n{n_hq_epochs}.bin')
